...
export class InscripcionService {
  ...
  async cancelarInscripcion(inscripcionId: number, userId: number): Promise<void> {
    ...
    if (inscripcion.estudiante.id !== userId) {
      throw new BadRequestException('No tienes permisos para cancelar esta inscripción');
    }
